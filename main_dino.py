...
def get_args_parser():
    ...
    parser.add_argument('--img_size', default=224, type=int, help="Input size in pixels of the images for the ViT.")
    ...
    parser.add_argument('--dataset', default="", type=str, help="Name of the Dataset.")
